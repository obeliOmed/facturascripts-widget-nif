...
- **Pasaporte sin verificación real** (ver Sec anterior) — cualquier 6-12 alfanumérico no-NIF/NIE/CIF pasa. Un atributo `allowPassport="false"` para desactivar este fallback **NO existe todavía** — es una mejora pendiente, no la menciones a usuarios/clientes como disponible.
